...
?>
                ...
                <div class="container-fluid">
                    ...
                    <?php
$result = $db_handle->runQuery("select * from aboutcontent where id='".$_REQUEST['id']."'");
foreach($result as $row) { ?>


<form class="cmxform form-horizontal style-form" id="signupForm" action="acontentupdate.php"
                ...
                <div class="form-group"><label for="exampleInputEmail1">Heading</label><input type="text"name="edit_heading" value="<?php echo $row['heading'];?>" required 
                    ...
                    <div class="form-group"><label for="exampleInputEmail1">sub-Heading</label><input type="text"name="edit_subheading" value="<?php echo $row['subheading'];?>" required 
                    class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                    placeholder="Enter text"> </div>
                <div class="form-group"><label for="exampleInputPassword1">Description</label><textarea name="edit_description"  required 
