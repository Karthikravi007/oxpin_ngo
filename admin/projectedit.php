...
?>
                ...
                <div class="container-fluid">
                    ...
                    <?php
$result = $db_handle->runQuery("select * from homeproject where id='".$_REQUEST['id']."'");
foreach($result as $row) { ?>


<form class="cmxform form-horizontal style-form" id="signupForm" action="projectupdate.php"
