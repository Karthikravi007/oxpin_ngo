...
?>
                ...
                <div class="container-fluid">
                    ...
                    <h4>Volunteers </h4>
                    <?php
$result = $db_handle->runQuery("select * from content where id='".$_REQUEST['id']."'");
foreach($result as $row) { ?>


<form class="cmxform form-horizontal style-form" id="signupForm" action="content_update.php"
