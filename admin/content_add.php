...
?>
                ...
                <div class="container-fluid">
                    ...
                    <form class="cmxform form-horizontal style-form" id="signupForm" action="content_save.php"
                ...
                method="post">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="subheading" rows="2" id="comment"></textarea>
                              </div>
                              <div class="form-group">
