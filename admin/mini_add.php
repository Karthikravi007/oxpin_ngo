...
?>
                ...
                <div class="container-fluid">
                    ...
                    <form class="cmxform form-horizontal style-form" id="signupForm" action="mini_save.php"
                ...
                method="post">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="exprience" rows="1" id="comment"></textarea>
                              </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <textarea class="form-control" name="subheading1" rows="1" id="comment"></textarea>
                              </div>
                              <h5>Change Description1</h5>
                            <div class="form-group">
                                <label for="comment">description:</label>
                                <textarea class="form-control"  name="description1" rows="5" id="comment"></textarea>
                              </div>
                              <h5>Change Subheading2</h5>
                              <div class="form-group">
                                <label for="comment" >Subheading2:</label>
                                <textarea class="form-control" name="subheading2" rows="1" id="comment"></textarea>
                              </div>
                              <h5>Change Description2</h5>
                            <div class="form-group">
                                <label for="comment">description:</label>
                                <textarea class="form-control"  name="description2" rows="5" id="comment"></textarea>
                              </div>
                              <div class="form-group">
