...
?>
                ...
                <div class="container-fluid">
                    ...
                    <form class="cmxform form-horizontal style-form" id="signupForm" action="aheadingsave.php"
                ...
                method="post">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="subheading" rows="5" id="comment"></textarea>
                              </div>
