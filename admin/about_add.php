...
?>
                ...
                <div class="container-fluid">
                    ...
                    <h4>Volunteers Content & Image Change</h4>
                    <form class="cmxform form-horizontal style-form" id="signupForm" action="about_save.php"
                ...
                method="post">
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                <label for="exampleFormControlFile1" >Top Image Upload File</label>
                                <input type="file" name="t_image" class="form-control-file" id="exampleFormControlFile1">
                              </div>
                              <div class="form-group">
                                <label for="exampleFormControlFile1" >bottom Image Upload File</label>
