...
?>
                ...
                <div class="container-fluid">
                    ...
                    <?php
$result = $db_handle->runQuery("select * from testimonial where id='".$_REQUEST['id']."'");
foreach($result as $row) { ?>


<form class="cmxform form-horizontal style-form" id="signupForm" action="testimonial_update.php"
                ...
                <div class="form-group"><label for="exampleInputEmail1">Heading</label><input type="text"name="edit_heading" value="<?php echo $row['heading'];?>" required 
                    ...
                    <textarea class="form-control" name="description" rows="3" id="comment"><?php echo $row['description'];?></textarea>
                    </div>
