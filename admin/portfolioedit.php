...
?>
                ...
                <div class="container-fluid">
                    ...
                    <h4>Gallery</h4>
                    <?php
$result = $db_handle->runQuery("select * from gallery where id='".$_REQUEST['id']."'");
foreach($result as $row) { ?>

                    <form class="cmxform form-horizontal style-form" id="signupForm" action="portfolioupdate.php"
                ...
                method="post">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="subheading" rows="1" id="comment"><?php echo $row['subheading'];?></textarea>
                              </div>
                              <div class="form-group">
