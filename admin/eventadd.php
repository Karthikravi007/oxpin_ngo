...
?>
                ...
                <div class="container-fluid">
                    ...
                    <h4>Event</h4>
                    <form class="cmxform form-horizontal style-form" id="signupForm" action="eventsave.php"
                enctype="multipart/form-data" 
                method="post">
                
                            <h5>Event Heading</h5>
                            <div class="form-group">
                                <label for="comment" >Event Heading:</label>
                                <textarea class="form-control" name="heading" rows="1" id="comment"></textarea>
                              </div>
                              <h5>Event Date</h5>
                            <div class="form-group">
                                <label for="comment" >Event Date:</label>
