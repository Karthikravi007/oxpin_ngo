...
?>
                ...
                <div class="container-fluid">
                    ...
                    <h4>Donation : </h4>
                    <form class="cmxform form-horizontal style-form" id="signupForm" action="donate_save.php"
                ...
                method="post">
                            ...
                            <div class="form-group">
                                <label for="comment" >Goals:</label>
                                <textarea class="form-control" name="goal" rows="1" id="comment"></textarea>
                              </div>
                            <div class="form-group">
                                <label for="comment" >Raised:</label>
                                <textarea class="form-control" name="raised" rows="1" id="comment"></textarea>
                              </div>
                              <div class="form-group">
